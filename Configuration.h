...
#define STRING_CONFIG_H_AUTHOR "SW & CM" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "FolgerTech i3 2020"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {X_STEPS,Y_STEPS,Z_STEPS,E_STEPS}  // default steps per unit for ultimaker {78.7402,78.7402,200*8/3,760*1.1}920
